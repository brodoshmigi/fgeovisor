...
class Image(models.Model):
    ...
    local_uri = models.ImageField(upload_to='fgeovisor/images/IMAGES', null=True)
    real_uri = models.URLField(unique=True, null=True)
...
class NasaImage(Image):
    ...
    poly_bounds = models.ForeignKey(Polygon,
...
class UserImage(Image, ImageType):
    ...
    polygon_id = models.ForeignKey(Polygon,
